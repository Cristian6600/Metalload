...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'Metalload/templates'],  # 🔥 Agregar directorio de templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MAIN_API_ENDPOINT = '/api/v1/asignar/'  # Endpoint CORRECTO para asignar clientes
...
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'  # Ruta local para desarrollo
